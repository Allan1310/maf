...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="oa:oaNotify:edit"><li><a href="${ctx}/oa/oaNotify/">通知列表</a></li>
		...
		<li class="active"><a href="${ctx}/oa/oaNotify/view?id=${oaNotify.id}">通知<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
