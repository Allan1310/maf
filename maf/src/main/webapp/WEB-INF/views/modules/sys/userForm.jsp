	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnSyn").click(function(){
				$.jBox.confirm('确定要同步吗', '提示', function (v, h, f) {
					if (v == 'ok') {
						$("#inputForm").attr("action","${ctx}/sys/user/synUser");
						$("#method").val("syn");
						$("#name").attr("class","");
						$("#loginName").attr("class","");
						$("#newPassword").attr("class","");
						$("#mobile").attr("class","");
						$("#phone").attr("class","");
						$("#userType").attr("class","");
						$("#loginType").attr("class","");
						$("#inputForm").submit();
					}
				});
			});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="userType" class="required input-xlarge">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="loginType" class="required input-xlarge">
					<form:option value="" label="请选择"/>
					<form:options items="${fns:getDictList('sys_login_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">职务职位:</label>
			<div class="controls">
		...
		<div class="form-actions">
			...
			<shiro:hasPermission name="sys:user:edit"><input id="btnSyn" class="btn btn-warning" type="button" value="同 步"/>&nbsp;</shiro:hasPermission>
