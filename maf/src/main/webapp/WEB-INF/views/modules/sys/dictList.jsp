...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/dict/?modules=${modules}">字典列表</a></li>
		<shiro:hasPermission name="sys:dict:edit"><li><a href="${ctx}/sys/dict/form?sort=10&modules=${modules}">字典添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="dict">
			<tr>
				...
				<shiro:hasPermission name="sys:dict:edit"><td>
    				...
    				<a href="<c:url value='${fns:getAdminPath()}/sys/dict/form?type=${dict.type}&sort=${dict.sort+10}&modules=${dict.modules }'><c:param name='description' value='${dict.description}'/></c:url>">添加键值</a>
