	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function getNotifyNum(){
				$.get("${ctx}/msg/msgMsginfo/self/count?receiverId="+${fns:getUser().id},function(data){
...
<body>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top top-wrapper" >
			<div class="navbar-inner">
				<div style="float:left;padding:5px 15px 0 15px;" >
					<a href="${ctx}" title=""><img src="${ctxStatic}/images/logo.png"  style="height:38px;" /></a>
	    		</div>
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:cookie('tabmode','${tabmode eq '1' ? '0' : '1'}');location=location.href"><i class="icon-eye-open"></i>&nbsp;  ${tabmode eq '1' ? '关闭' : '开启'}页签模式</a></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.allinfnt.com" target="_blank">Allinfnt</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
