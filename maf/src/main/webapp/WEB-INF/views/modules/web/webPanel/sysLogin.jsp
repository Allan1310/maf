...
<html >
    <head>
		...
		//	$("#validateCode_img").attr('src','/idc/servlet/validateCodeServlet?'+new Date().getTime())
    ...
    <body>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <div class="input-prepend yzm">
                                ...
                                <span class="login_yzm"><img id="validateCode_img" src="${ctx}/servlet/validateCodeServlet" onclick="$(this).attr('src','/idc/servlet/validateCodeServlet?'+new Date().getTime());"></span>
                            </div>
                        </div>
                    </div> 
        ...
        <div class="copy_right">2015 &copy;通联金融科技</div>
    <script>
