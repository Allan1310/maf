(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<tr height=20><td colspan=22 bgcolor=#e2e2e2>'
            +'<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">'
            +'<tr><td width="3"><td><input type="text" id="DisColor" style="margin-top:5px; width:40px;height:12px;border:solid 1px #000000;border-radius:0px;background-color:#ffff00"></td>'
            +'<td width="3"><td><input type='+(opts.inputshow?"hidden":"text")+' id="HexColor" style="margin-top:5px; width:80px;height:12px;border-radius:0px;border:1px solid #000000;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> '+(opts.inputshow?"":"<a href='javascript:void(0);'id='_creset'>清除</a>")+'</td></tr></table></td></table>'
            +'<table id="CT" border="1" width=253 cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#000000"  style="cursor:pointer;">'
            +colorTable+'</table>';
