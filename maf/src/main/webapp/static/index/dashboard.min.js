...
var handleInteractiveChart = function() { // 曲线图
    "use strict";
    function e(e, t, n) {
    ...
    if ($("[dataid='interactive-chart']").length !== 0) {
        ...
        $("[dataid='interactive-chart']").each(function(i,item){
            $.plot($(item), [{
                data: t,
                label: "Page Views",
                color: blue,
...
var handleDonutChart = function() {   //圆形图
    "use strict";
...
var handleDashboardSparkline = function() { //条形图
    "use strict";
    function t() {
...
var handleDashboardDatepicker = function() { //日期
    $("[dataid='datepicker-inline']").each(function(){
		$(this).datepicker({
			todayHighlight: true
		});
	});
...
var handleDashboardGritterNotification = function() { //浮动弹出窗口 
