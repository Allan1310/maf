(function(t, e) {
	...
	function r(n, r, c) {
		...
		function v() {
			setTimeout(function() { ! te.start && m() && w()
			},
			0)
		}
		function h() {
			t(window).unbind("resize", E),
			$.destroy(),
			G.remove(),
		...
		function y(e) {
			if (!te || e != te.name) {
				...
				L();
				var n, r = te;
				r ? ((r.beforeHide || O)(), A(G, G.height()), r.element.hide()) : A(G, 1),
				G.css("overflow", "hidden"),
				te = le[e],
				te ? te.element.show() : te = le[e] = new ye[e](n = re = t("<div class='fc-view fc-view-" + e + "' style='position:absolute'/>").appendTo(G), Z),
		...
		function w(t) {
			if (p()) {
				...
				L(),
				ne === e && T();
				var r = !1; ! te.start || t || te.start > fe || fe >= te.end ? (te.render(fe, t || 0), S(!0), r = !0) : te.sizeDirty ? (te.clearEvents(), S(), r = !0) : te.eventsDirty && (te.clearEvents(), r = !0),
				te.sizeDirty = !1,
				te.eventsDirty = !1,
				x(r),
				ee = n.outerWidth(),
		...
		function C() {
			M(),
			p() && (T(), S(), L(), te.clearEvents(), te.renderEvents(de), te.sizeDirty = !1)
		}
		function M() {
			t.each(le,
			function(t, e) {
		...
		function x(t) { ! r.lazyFetching || oe(te.visStart, te.visEnd) ? k() : t && R()
		}
		function k() {
		...
		function R(t) {
			N(),
			p() && (te.clearEvents(), te.renderEvents(de, t), te.eventsDirty = !1)
		}
		function N() {
			t.each(le,
			function(t, e) {
		...
		function j(t, e, n) {
			t instanceof Date ? fe = d(t) : g(fe, t, e, n),
			w()
		}
		function Y(t, n, r) {
			t !== e && i(fe, t),
	...
	function o(n, r) {
		...
		function s(r, a) {
			...
			var c = r.events;
			if (c) t.isFunction(c) ? (m(), c(d(T), d(S),
			function(t) {
				a(t),
				y()
			})) : t.isArray(c) ? a(c) : a();
		...
		function f(t) {
			...
			for (e = 0; r > e; e++) n = W[e],
			n._id == t._id && n != t && (n.start = new Date( + n.start + o), n.end = t.end ? n.end ? new Date( + n.end + i) : new Date( + a(n) + i) : null, n.title = t.title, n.url = t.url, n.allDay = t.allDay, n.className = t.className, n.editable = t.editable, n.color = t.color, n.backgroundColor = t.backgroundColor, n.borderColor = t.borderColor, n.textColor = t.textColor, b(n));
			b(t),
			k(W)
		}
		function v(t, e) {
		...
		function y() {--N || E("loading", null, !1)
		}
		function b(t) {
			var r = t.source || {},
			a = V(r.ignoreTimezone, n.ignoreTimezone);
			t._id = t._id || (t.id === e ? "_fc" + De++:t.id + ""),
			...
			t.allDay === e && (t.allDay = V(r.allDayDefault, n.allDayDefault)),
			t.className ? "string" == typeof t.className && (t.className = t.className.split(/\s+/)) : t.className = []
		}
		function D(t) {
			t.className ? "string" == typeof t.className && (t.className = t.className.split(/\s+/)) : t.className = [];
			for (var e = me.sourceNormalizers,
	...
	function $(e, n, r) {
		...
		function o() {
			...
			ye = Me("columnFormat"),
			be = Me("weekNumbers"),
			De = Me("weekNumberTitle"),
			Ce = "iso" != Me("weekNumberCalculation") ? "w": "W"
		}
		function i() {
		...
		function s() {
			...
			X = V.find("tr"),
			U = V.find(".fc-day"),
			Z = X.find("td:first-child"),
			$ = X.eq(0).find(".fc-day > div"),
			G = X.eq(0).find(".fc-day-content > div"),
			j(Y.add(Y.find("tr"))),
			j(X),
			X.eq(0).addClass("fc-first"),
			X.filter(":last").addClass("fc-last"),
			U.each(function(e, n) {
		...
		function u() {
			...
			r = "";
			for (r += "<thead><tr>", be && (r += "<th class='fc-week-number " + n + "'>" + I(De) + "</th>"), t = 0; ie > t; t++) e = He(0, t),
			r += "<th class='fc-day-header fc-" + we[e.getDay()] + " " + n + "'>" + I(Re(e, ye)) + "</th>";
			return r += "</tr></thead>"
		}
		function v() {
			...
			for (a += "<tbody>", t = 0; ae > t; t++) {
				for (a += "<tr class='fc-week'>", be && (n = He(t, 0), a += "<td class='fc-week-number " + r + "'>" + "<div>" + I(Re(n, Ce)) + "</div>" + "</td>"), e = 0; ie > e; e++) n = He(t, e),
				a += h(n);
				a += "</tr>"
			}
			return a += "</tbody>"
		...
		function h(t) {
			...
			+t == +r && o.push("fc-today", me + "-state-highlight"),
			a += "<td class='" + o.join(" ") + "'" + " data-date='" + Re(t, "yyyy-MM-dd") + "'" + ">" + "<div>",
			se && (a += "<div class='fc-day-number'>" + t.getDate() + "</div>"),
			a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>"
		}
		function g(e) {
			ee = e;
			var n, r, a, o = ee - Y.height();
			"variable" == Me("weekMode") ? n = r = Math.floor(o / (1 == ae ? 2 : 6)) : (n = Math.floor(o / ae), r = o - n * (ae - 1)),
			Z.each(function(e, o) {
		...
		function p(t) {
			...
			pe.clear(),
			re = 0,
			be && (re = Y.find("th.fc-week-number").outerWidth()),
			ne = Math.floor((te - re) / ie),
			S(J.slice(0, -1), ne)
		}
		function y(t) {
		...
		Re = n.formatDate;
		P(e.addClass("fc-grid")),
		le = new fe(function(e, n) {
			var r, a, o;
			J.each(function(e, i) {
				r = t(i),
				a = r.offset().left,
	...
	function te(n, r, a) {
		...
		function c() {
			...
			te = t(e).appendTo(n),
			ne = te.find("thead"),
			re = ne.find("th").slice(1, -1),
			ae = te.find("tbody"),
			ie = ae.find("td").slice(0, -1),
			se = ie.find("> div"),
			le = ie.find(".fc-day-content > div"),
			ve = ie.eq(0),
			ge = se.eq(0),
			j(ne.add(ne.find("tr"))),
			j(ae.add(ae.find("tr")))
		...
		function g() {
			...
			a = "";
			for (a += "<thead><tr>", Ue ? (e = un(t, $e), Ye ? e += Ze: e = Ze + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + I(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; Oe > n; n++) t = sn(0, n),
			a += "<th class='fc-" + we[t.getDay()] + " fc-col" + n + " " + r + "'>" + I(un(t, Xe)) + "</th>";
		...
		function p() {
			...
			s = f(new Date),
			l = "";
			for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; Oe > e; e++) t = sn(0, e),
			a = ["fc-col" + e, "fc-" + we[t.getDay()], i],
			+t == +s && a.push(je + "-state-highlight", "fc-today"),
		...
		function b(e) {
			...
			ye && (n = n.add(ye.find("th:first"))),
			n = n.add(Te.find("th:first")),
			He = 0,
			...
			Fe = De.width() - a,
			Fe ? (S(r, Fe), r.show().prev().removeClass("fc-last")) : r.hide().prev().addClass("fc-last"),
			ze = Math.floor((a - He) / Oe),
			S(re.slice(0, -1), ze)
		}
		function D() {
			function t() {
		...
		function q(t, n) {
			...
			o = Math.floor(a / r),
			i = fn[o];
			return i === e && (i = fn[o] = Te.find("tr:eq(" + o + ") td div")[0].offsetTop),
			...
			if (1 == e.which && Qe("selectable")) {
				...
				qe.start(function(t, e) {
					if (U(), t && t.col == e.col && !O(t)) {
						var r = _(e),
						a = _(t);
						n = [r, u(d(r), Ne), a, u(d(a), Ne)].sort(L),
						X(n[0], n[3])
					} else n = null
				},
				e),
				...
				function(t) {
					qe.stop(),
					n && ( + n[0] == +n[1] && $(n[0], !1, t), nn(n[0], n[3], !1, t))
				})
			}
		}
		function $(t, e, n) {
		...
		function Q(t, e) {
			qe.start(function(t) {
				if (en(), t) if (O(t)) H(t.row, t.col, t.row, t.col);
				else {
					var e = _(t),
		...
		K.defaultSelectionEnd = J,
		K.renderDayOverlay = k,
		K.renderSelection = V,
		K.clearSelection = U,
		K.reportDayClick = $,
		K.dragStart = Q,
		...
		un = r.formatDate,
		fn = {};
		P(n.addClass("fc-agenda")),
		_e = new fe(function(e, n) {
			function r(t) {
	...
	function ee() {
		...
		function a(e) {
			...
			p = t.map(e, i),
			m = [];
			for (r = 0; v > r; r++) for (n = B(0, r), u(n, h), a = ne(o(e, p, n, u(d(n), g - h))), re(a), s = 0; a.length > s; s++) for (l = a[s], c = 0; l.length > c; c++) f = l[c],
			f.col = r,
			f.level = s,
			m.push(f);
			return m
		...
		function s(n, r) {
			...
			z = "",
			R = N();
			for (k = (E = y("isRTL")) ? -1 : 1, a = 0; H > a; a++) o = n[a],
			i = o.event,
			s = L(o.start, o.start),
			l = L(o.start, o.end),
			u = o.col,
			...
			m = h + g / (d + v + 1) * d * k + (E ? g - p: 0),
			o.top = s,
			o.left = m,
			o.outerWidth = p,
			o.outerHeight = l - s,
			z += c(i, o);
			for (R[0].innerHTML = z, D = R.children(), a = 0; H > a; a++) o = n[a],
			i = o.event,
			w = t(D[a]),
			...
			for (T(R, n, f), a = 0; H > a; a++) o = n[a],
			(w = o.element) && (o.vsides = F(w, !0), o.hsides = x(w, !0), M = w.find(".fc-event-title"), M.length && (o.contentTop = M[0].offsetTop));
			for (a = 0; H > a; a++) o = n[a],
			(w = o.element) && (w[0].style.width = Math.max(0, o.outerWidth - o.hsides) + "px", S = Math.max(0, o.outerHeight - o.vsides), w[0].style.height = S + "px", i = o.event, o.contentTop !== e && 10 > S - o.contentTop && (w.find("div.fc-event-time").text(se(i.start, y("timeFormat")) + " - " + i.title), w.find("div.fc-event-title").remove()), b("eventAfterRender", i, i, w))
		}
		function c(t, e) {
			var n = "<",
			r = t.url,
			...
			n += r ? "a href='" + I(t.url) + "'": "div",
			n += " class='" + o.join(" ") + "'" + " style='position:absolute;z-index:8;top:" + e.top + "px;left:" + e.left + "px;" + a + "'" + ">" + "<div class='fc-event-inner'>" + "<div class='fc-event-time'>" + I(le(t.start, t.end, y("timeFormat"))) + "</div>" + "<div class='fc-event-title'>" + I(t.title) + "</div>" + "</div>" + "<div class='fc-event-bg'></div>",
		...
		function v(t, e, n) {
			...
			e.draggable({
				...
				start: function(n, p) {
					...
					u.start(function(n, a) {
						if (ee(), n) {
							...
							p = B(0, n.col);
							i = h(p, u),
							n.row ? s ? c && (e.width(f - 10), E(e, v * Math.round((t.end ? (t.end - t.start) / Te: y("defaultEventMinutes")) / g)), e.draggable("option", "grid", [f, 1]), c = !1) : o = !0 : (te(l(d(t.start), i), l(C(t), i)), r()),
							o = o || c && !i
						} else r(),
						o = !0;
				...
				stop: function(n, a) {
					if (u.stop(), ee(), b("eventDragStop", e, t, n, a), o) r(),
					e.css("filter", ""),
					$(t, e);
					else {
						var s = 0;
						c || (s = Math.round((e.offset().top - U().offset().top) / v) * g + p - (60 * t.start.getHours() + t.start.getMinutes())),
						G(this, t, i, s, c, n, a)
					}
				}
			})
		...
		function g(t, e, n) {
			...
			e.draggable({
				...
				start: function(r, u) {
					...
					o = e.position(),
					s = c = 0,
					v.start(function(r, o) {
						if (e.draggable("option", "revert", !r), ee(), r) {
							var s = B(0, o.col),
							c = B(0, r.col);
							i = h(c, s),
							y("allDaySlot") && !r.row ? (f || (f = !0, n.hide(), e.draggable("option", "grid", null)), te(l(d(t.start), i), l(C(t), i))) : a()
						}
					},
					r, "drag")
				},
				drag: function(t, e) {
					s = Math.round((e.position.top - o.top) / m) * D,
					s != c && (f || r(s), c = s)
				},
				stop: function(n, l) {
					var c = v.stop();
					ee(),
					b("eventDragStop", e, t, n, l),
					c && (i || s || f) ? G(this, t, i, f ? 0 : s, f, n, l) : (a(), e.css("filter", ""), e.css(o), r(0), $(t, e))
				}
			})
		}
		function p(t, e, n) {
			...
			e.resizable({
				...
				resize: function(s, l) {
					...
					r != a && (n.text(le(t.start, r || t.end ? u(M(t), i * r) : null, y("timeFormat"))), a = r)
				},
				stop: function(n, a) {
					b("eventResizeStop", this, t, n, a),
					r ? K(this, t, 0, i * r, n, a) : (e.css("z-index", 8), $(t, e))
				}
			})
		}
		var m = this;
	...
	function re(t) {
		...
		ae(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
	}
	function ae(t, e) {
	...
	function oe(n, r, a) {
		...
		function p(t, e) {
			X.push(e),
			U[t._id] ? U[t._id].push(e) : U[t._id] = [e]
		}
		function m() {
			X = [],
			U = {}
		...
		I.opt = o,
		I.trigger = i,
		I.isEventDraggable = s,
		I.isEventResizable = c,
		I.reportEvents = v,
		I.eventEnd = g,
		I.reportEventElement = p,
		I.reportEventClear = m,
		I.eventElementHandlers = y,
		I.showEvents = b,
		I.hideEvents = D,
		I.eventDrop = C,
		I.eventResize = M;
		...
		I.dateToCell = N,
		I.dateToDayOffset = W,
		I.dayOffsetToCellOffset = A,
		I.cellOffsetToCell = O,
		I.cellToDate = H,
		I.cellToCellOffset = z,
		I.cellOffsetToDayOffset = F,
		I.dayOffsetToDate = R,
		I.rangeToSegments = L,
		I.segmentCompare = _;
		var $, Q = o("hiddenDays") || [],
	...
	function ie() {
		...
		function c(t) {
			...
			var i = Y(r, E);
			return e += a ? "<a href='" + I(a) + "'": "<div",
			e += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "z-index:8;" + "left:" + t.left + "px;" + i + "'" + ">" + "<div class='fc-event-inner'>",
			!r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + I($(r.start, r.end, E("timeFormat"))) + "</span>"),
			e += "<span class='fc-event-title'>" + I(r.title) + "</span>" + "</div>",
			t.isEnd && z(r) && (e += "<div class='ui-resizable-handle ui-resizable-" + (n ? "w": "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"),
			e += "</" + (a ? "a": "div") + ">"
		}
		function u(e, n) {
		...
		function D(t, e, n) {
			...
			n.isEnd && z(t) && S.resizableDayEvent(t, e, n),
			N(t, e)
		}
		function w(t, e) {
			var n, r = te();
		...
		function a(e) {
			...
			if (1 == e.which && i("selectable")) {
				...
				l.start(function(t, e) {
					u(),
					t && s(t) ? (d = [a(e), a(t)].sort(L), c(d[0], d[1], !0)) : d = null
				},
				e),
				t(document).one("mouseup",
				function(t) {
	...
	var ge = {
		...
		dayNamesShort: ["606会议室", "808会议室", "505会议室", "503会议室", "398会议室", "3432会议室", "433会议室"],
		buttonText: {
	...
	t.fn.fullCalendar = function(n) {
		...
		n = t.extend(!0, {},
		ge, n.isRTL || n.isRTL === e && ge.isRTL ? pe: {},
		n),
