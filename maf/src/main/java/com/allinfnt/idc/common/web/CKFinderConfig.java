 ...
 */
package com.allinfnt.idc.common.web;
...
public class CKFinderConfig extends Configuration {
	...
	protected Configuration createConfigurationInstance() {
		...
		boolean isView = UserUtils.getSubject()
				.isPermitted("cms:ckfinder:view");
		boolean isUpload = UserUtils.getSubject().isPermitted(
				"cms:ckfinder:upload");
		boolean isEdit = UserUtils.getSubject()
				.isPermitted("cms:ckfinder:edit");
