...
import com.allinfnt.idc.modules.gen.dao.GenDataBaseDictDao;
...
public class GenTableService extends BaseService {
	...
	public void delete(GenTable genTable) {
		...
		//	test_data_main 
		//	test_tree 表可以删除表结构
		if(!genTable.getName().equals("test_data") || !genTable.getName().equals("test_data_child") || !genTable.getName().equals("test_data_main") || !genTable.getName().equals("test_tree")){
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("tableName", genTable.getName());
			List<GenTable> list = genTableDao.selectTableColumn(map);
			...
			System.out.println("共 "+ ids.length +",删除表字段id :"+str);
			map.put("ids", ids);
			genTableDao.deleteTableColumn(map); // 删除 gen_table_column 数据列记录
			genTableDao.deleteTableRecord(map); // 删除 gen_table 列表记录
			genTableDao.dropDelete(map); // 删除表物理结构
		}else{
