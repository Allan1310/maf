...
public class CmCiInstance extends DataEntity<CmCiInstance> {
	...
	@Length(min=0, max=2, message="配置项状态（9：借用，10：借出，11：开发）长度必须介于 0 和 2之间")
	...
	@Length(min=0, max=1, message="状态长度必须介于 0 和 1 之间 状态（0：配置项初始化，1：正常状态，2：正在变更，3：正在审批，4：配置项属于配置项模型，5：删除）")
	...
	@Length(min=0, max=100, message="扩展字段1长度必须介于 0 和 100 之间")
	...
	@Length(min=0, max=100, message="扩展字段2长度必须介于 0 和 100 之间")
