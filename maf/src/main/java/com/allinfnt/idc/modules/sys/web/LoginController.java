...
import com.allinfnt.idc.common.utils.CookieUtils;
import com.allinfnt.idc.common.utils.IdGen;
...
import com.allinfnt.idc.modules.sys.security.FormAuthenticationFilter;
...
public class LoginController extends BaseController {
	...
	public String login(HttpServletRequest request,
		...
		// view = "classpath:";
		// view +=
		// "jar:file:/D:/GitHub/idc/src/main/webapp/WEB-INF/lib/idc.jar!";
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		if("3".equals(user.getUserType())){
			return "modules/web/webPanel/sysIndex";
		}
		else{
			return "modules/sys/sysIndex";
		}
		...
		// try {
		// byte[] bytes =
		// com.allinfnt.idc.common.utils.FileUtils.readFileToByteArray(
		// com.allinfnt.idc.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
