...
import com.allinfnt.idc.annotation.FieldName;
import com.allinfnt.idc.common.config.Global;
import com.allinfnt.idc.common.utils.Encodes;
import com.allinfnt.idc.common.utils.ObjectUtils;
...
public class ActUtils {
    ...
    public static final String[] PD_CI_APPLY                   = new String[] { "ciApply", "cm_ci_apply" };
    public static final String[] PD_AUDIT_APPLY                = new String[] { "auditApply", "cm_audit_apply" };
    public static final String[] PD_RMVSAPPLICATIONINFORMATION = new String[] { "rmVsApplicationInformation", "rm_vs_application_information" };
    public static final String[] PD_HM_CREATE_AUDIT 		   = new String[] { "hmCreateAudit", "hm_defined_manage" };//作业定义创建审批流程
    public static final String[] PD_SM_APPLY                   = new String[] { "smApply", "sm_apply"};
    public static final String[] PD_RM_APPLYAUDIT              = new String[] { "auditApplyRm", "rm_rm_apply" };
    public static final String[] PD_SD_SERVICEAPPLY            = new String[] { "serviceApply", "sd_service_apply" };
    public static final String[] PD_CS_CREATE_AUDIT 		   = new String[] { "csCustomAudit", "cs_custom_manage" };//客户服务管理流程
    //	/**
    //	 * 流程定义Map（自动初始化）
    //	 */
