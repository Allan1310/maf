...
(
	...
	rule varchar(100) COMMENT '生成规则',
	gen_every_day char(1) COMMENT '每天生成',
	no_length int COMMENT '号码长度',
	init_value int COMMENT '初始值',
	cur_value int COMMENT '当前值',
	cur_date varchar(10) COMMENT '当前日期',
	step int COMMENT '步长',
	create_by varchar(64) NOT NULL COMMENT '创建者',
	create_date datetime NOT NULL COMMENT '创建时间',
	update_by varchar(64) NOT NULL COMMENT '更新者',
...
(
	...
	module varchar(10) COMMENT '所属模块',
...
-- 工作日信息表
CREATE TABLE sys_set_weekday
(
	id varchar(64) NOT NULL COMMENT '主键id',
	day varchar(10) COMMENT '工作日日期',
	create_by varchar(64) COMMENT '创建者',
	create_date datetime COMMENT '创建时间',
...
(
	...
	login_type char(1) COMMENT '登录类型',
	position varchar(100) COMMENT '职务职位',
	weixin_id varchar(100) COMMENT '微信ID',
...
CREATE INDEX sys_mdict_parent_ids ON sys_mdict ();
...
CREATE INDEX sys_office_parent_ids ON sys_office ();
